...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_1.setText(_translate("Form", "Open"))
        self.comboBox.setWhatsThis(_translate("Form", "Choose what to show"))
        ...
        self.pushButton_3.setText(_translate("Form", "Automatic copy（开）"))
        self.pushButton_2.setText(_translate("Form", "Shut down"))
